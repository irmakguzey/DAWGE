...
def infonce(encoder, trans, obs, obs_next, action):
    ...
    # print(f'z.shape: {z.shape}, z_next_predict.shape: {z_next_predict.shape}')
    ...
    # print(f'neg_dot_products.shape: {neg_dot_products.shape}, neg_dists.shape: {neg_dists.shape}')
